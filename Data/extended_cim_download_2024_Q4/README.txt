...
Additional regional assignments for each facility (available for facilities with known
precise location only)

From the US Census Bureau:
* Land Area
* Population density
* county_2020_fips_code
* county_2020_geoid
* census_tract_2020_id
* census_tract_2020_geoid
* census_tract_2020_name
* county_2010_fips_code
* county_2010_geoid
* census_tract_2010_id
* census_tract_2010_geoid
* census_tract_2010_name
* census_2022_zip5

From NETL (https://edx.netl.doe.gov/dataset/ira-energy-community-data-layers)
* coal_closure_community
* fossil_fuel_employment_community
* energy_community

From CEJST (https://screeningtool.geoplatform.gov/en/downloads)
...
NMTC Columns
Geographic Eligibility for Category 1 applications determined by New Market Tax Credit
thresholds for Low Income https://www.cdfifund.gov/programs-training/programs/new-markets-tax-credit.
Download from: https://www.cdfifund.gov/documents/geographic-reports
* NMTC_low_income_qualification
...
Priority energy community designation (see https://energycommunities.gov/priority-energy-communities/)
* PriorityEnergyCommunity
* PriorityECRank
* IsPriorityEC
